...
var DEBUG, NO_COLOR, NO_WARNINGS, TRACE_WARNINGS, cleanStack, colorize, createLog, createWriter, def, env, format, getPrefix, hasFlag, inspect, isCLI, isQuiet, join, log, methods, muted, quiet, undef;
...
methods.trace = (function() {
  ...
  return function(framesToPop = 0) {
    ...
    return this.write(this.gray(stack));
  };
})();
...
if (isQuiet || !(DEBUG = env.DEBUG)) {
  ...
  methods.debug = function(id) {
    return createLog().prefix(log.coal(id));
  };
} else {
